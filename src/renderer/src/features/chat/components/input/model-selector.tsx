...
const ModelSelector: React.FC<ModelSelectorProps> = ({
  ...
  return (
    <Popover>
      ...
      <PopoverContent
        className="w-64 min-h-32 overflow-hidden rounded-lg border border-border/60 bg-popover p-0 shadow-lg data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95"
        side="top"
        align="start"
        sideOffset={8}
      >
