...
const ChatInputBox: React.FC<ChatInputBoxProps> = ({
  ...
  return (
    <div
      className="flex flex-col gap-4 bg-[var(--chat-input-background)] h-full rounded-2xl items-center border border-stone-300 dark:border-stone-600 w-full max-w-full sm:max-w-lg md:max-w-xl lg:max-w-2xl xl:max-w-3xl mx-auto"
      style={{
