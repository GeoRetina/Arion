...
export const ChatInputButtons: React.FC<ChatInputButtonsProps> = ({
  ...
  // Common button styling - theme-aware: white bg + black icon in dark, black bg + white icon in light
  const buttonStyle = 'rounded-lg bg-foreground text-background hover:bg-foreground/90 border-0 shadow-none'
